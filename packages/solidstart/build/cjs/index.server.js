...
const withServerActionInstrumentation = require('./server/withServerActionInstrumentation.js');
const middleware = require('./server/middleware.js');
const withSentryNitroConfig = require('./config/withSentryNitroConfig.js');
...
exports.withSentryNitroConfig = withSentryNitroConfig.withSentryNitroConfig;
exports.sentrySolidStartVite = sentrySolidStartVite.sentrySolidStartVite;
