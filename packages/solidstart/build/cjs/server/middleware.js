...
function sentryBeforeResponseMiddleware() {
  return async function onBeforeResponse(event, response) {
    ...
    core.addNonEnumerableProperty(response, '__sentry_wrapped__', true);
...
exports.sentryBeforeResponseMiddleware = sentryBeforeResponseMiddleware;
